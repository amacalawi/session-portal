!function($) {
    ...
    reports.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    reports.prototype.required_fields = function() {
    ...
    reports.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    reports.prototype.do_uploads = function($id) {
    ...
    {   
        ...
        */
        ...
        this.$body.on('click', '#export-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="reports_form"]');
            var $error = $.reports.validate($form, 0);
    ...
    //init reports
    $.reports = new reports, $.reports.Constructor = reports
