...
var Dashboard = function() {
    ...
    var daterangepickerInit = function() {
        ...
        function cb(start, end, label) {
            ...
            console.log(base_url + 'dashboard/get-data?range=' + fixed_url(range));
            $.ajax({
                type: 'GET',
                url: base_url + 'dashboard/get-data?range=' + fixed_url(range),
                success: function(response) {
                    console.log(response);
                    $('body .ajax-content').html(response);
                }
            });
        }
