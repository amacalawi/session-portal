...
var DatatableDataLocalDemo = function () {
	//== Private functions
 	console.log(base_url + 'applications/all');
	// demo initializer
	var demo = function () {
						...
						<div class="dropdown ' + dropup + '">\
							<a href="#" class="btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="' + base_url + 'applications/edit/' + row.AppID + '"><i class="la la-edit"></i> Edit Details</a>\
						    	<a class="dropdown-item" href="' + base_url + 'applications/delete/' + row.AppID + '"><i class="la la-remove"></i> Remove Details</a>\
