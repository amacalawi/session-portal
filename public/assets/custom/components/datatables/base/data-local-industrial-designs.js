...
var DatatableDataLocalDemo = function () {
	//== Private functions
 	console.log(base_url + 'applications/industrial-designs/all');
	// demo initializer
	var demo = function () {
			...
			data: {
				...
				source: {
		          read: {
		            // sample GET method
		            method: 'GET',
		            url: base_url + 'applications/industrial-designs/all',
		            map: function(raw) {
		              // sample data mapping
		              var dataSet = raw;
						...
						<div class="dropdown ' + dropup + '">\
							<a href="#" class="btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="' + base_url + 'applications/industrial-designs/edit/' + row.AppID + '"><i class="la la-edit"></i> Edit Details</a>\
						    	<a class="dropdown-item" href="' + base_url + 'applications/industrial-designs/delete/' + row.AppID + '"><i class="la la-remove"></i> Remove Details</a>\
						    	\
						  	</div>\
						</div>\
					';
