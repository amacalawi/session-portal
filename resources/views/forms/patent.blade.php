...
<form type="POST" class="m-form m-form--label-align-left- m-form--state-" id="m_form" enctype="multipart/form-data">
    ...
    <div class="m-wizard__form-step" id="m_wizard_form_step_3">
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="form-group m-form__group">
                    {{ Form::label('examination_date', 'Request for Examination Date', ['class' => '']) }}
                    {{ 
                        Form::text($name = 'examination_date', $value = $application->examination_date, 
                        $attributes = array(
                            'id' => 'examination_date',
                            'class' => 'form-control m-input m-input--solid date-picker',
    ...
    <div class="m-wizard__form-step" id="m_wizard_form_step_4">
        <div class="subsequent-form-4-1">
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="form-group m-form__group">
                        {{ Form::label('subs_amount_file1', 'Government Fees', ['class' => '']) }}
                        {{ 
        ...
        <div class="subsequent-form-4-2 hidden">
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="form-group m-form__group">
                        {{ Form::label('subs_amount_file2', 'Government Fees', ['class' => '']) }}
                        {{ 
                    ...
                    <div class="alert m-alert m-alert--default" role="alert">
                        ...
                        @if($application->app_id != '')
                            @if ($application->is_completed == 1) 
                                <label class="m-radio m-radio m-radio--info">
                                    <input type="radio" name="completed" value="Yes" checked="checked">
                                    Yes
                                    <span></span>
                                </label>
                                <label class="m-radio m-radio m-radio--info">
