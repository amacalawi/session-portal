                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            All Patents - <span class="breadcrumb-title">Manage</span>
                        </h3>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script src="{{ asset('assets/custom/components/datatables/base/data-local-patents.js') }}" type="text/javascript"></script>
@endpush
