...
<!-- <h6 class="m--margin-bottom-10">
	...
	<em class="m--font-info publish_by">{{ $application->publish_by }}</em>
</h6> -->
<h6 class="m--margin-bottom-10">
	<i class="flaticon-calendar-3"></i> 
	<strong>Registered Date:</strong> 
	<span class="reg_date">
		{{ (!empty($application->reg_date)) ? date('d-M-Y', strtotime($application->reg_date)) : '' }}
	</span>
</h6>
<h6 class="m--margin-bottom-10">
	<i class="flaticon-user"></i> 
	<strong>Registered By:</strong> 
	<em class="m--font-info publish_by">{{ $application->reg_by }}</em>
</h6>
<h6 class="m--margin-bottom-10">
