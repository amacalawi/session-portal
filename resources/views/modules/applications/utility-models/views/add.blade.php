                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            Utility Model Form - <span class="breadcrumb-title">Client Information</span>
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <div class="m-portlet m-portlet--full-height m-portlet--fit" style="min-height: 225px !important; position: relative;">
            ...
            <div class="m-portlet__body">
                ...
                <div class="m-widget4 m-widget4--chart-bottom app-widget-info">
                    @include('modules.applications.utility-models.views.info')        
                </div>
                <!--end::Widget 5-->
            </div>
        </div>
...
@push('scripts')
    <script src="{{ asset('assets/custom/components/forms/wizard/utility-model-wizard.js') }}" type="text/javascript"></script>
@endpush